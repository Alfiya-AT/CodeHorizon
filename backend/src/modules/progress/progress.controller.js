...
exports.updateVideoProgress = exports.getVideoProgress = exports.getSubjectProgress = void 0;
...
const getSubjectProgress = async (req, res, next) => {
    try {
        ...
        const progresses = await db_1.prisma.videoProgress.findMany({
            where: {
...
const updateVideoProgress = async (req, res, next) => {
    try {
        ...
        const video = await db_1.prisma.video.findUnique({ where: { id: Number(videoId) } });
        if (!video)
