            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, prisma.subject.create({
                            data: __assign(__assign({}, courseData), { isPublished: true, sections: {
                                    create: sections.map(function (section, sectionIdx) { return ({
                                        title: section.title,
                                        orderIndex: sectionIdx,
                                        videos: {
                                            create: section.videos.map(function (video, videoIdx) { return ({
